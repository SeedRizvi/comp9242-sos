...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Copy(dest->root_cnode, dest_cptr, seL4_WordBits,
                           src->root_cnode, src_cptr, seL4_WordBits, rights);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
}
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Delete(cspace->root_cnode, cptr, seL4_WordBits);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
}
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Mint(dest->root_cnode, dest_cptr, seL4_WordBits,
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Move(dest->root_cnode, dest_cptr, seL4_WordBits, src->root_cnode, src_cptr, seL4_WordBits);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
}
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Mutate(dest->root_cnode, dest_cptr, seL4_WordBits,
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_Revoke(cspace->root_cnode, cptr, seL4_WordBits);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_CNode_SaveCaller(cspace->root_cnode, cptr, seL4_WordBits);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
}
#endif
...
{
    cspace_ut_lock(); // STDSYNCTRACKING
    seL4_Error ret = seL4_IRQControl_GetTrigger(irq_cap, irq, level, dest->root_cnode, cptr, seL4_WordBits);
    cspace_ut_unlock(); // STDSYNCTRACKING
    return ret;
}
