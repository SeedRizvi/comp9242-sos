...
#define ST_INVALID 0    /* Invalid code for file */
...
/*************************************************************************/
/*                                   */
/* Helper ffunctions for system calls                */
/*                                   */
/*************************************************************************/
/* Creates system call to SOS server to write nbyte of buf to console
 * Returns the number of bytes written, 0 in case of error
 */
int console_write(seL4_CPtr ep, const char *buf, size_t nbyte);

/* Creates seL4Message of size "size" with syscall code
 * inputted into first register 
 */
