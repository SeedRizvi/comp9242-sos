...
typedef struct pt_meta pt_meta_t;
...
/** Maps a page, allocating intermediate structures and cslots with the cspace provided. Stores intermediate structures and frame reference in appropriate page table.
 *
 * If you *know* you can map the vaddr without allocating any other paging structures, or that it is
 * safe to allocate cslots, you can provide NULL as the cspace.
 *
 ...
 * @param rights          The access rights for the mapping
 * @param attr            The VM attributes to use for the mapping
 * @param frame_ref       The VM attributes to use for the mapping
 *
 * @return 0 on success
 */
seL4_Error sos_map_frame(pt_meta_t *pt, seL4_CPtr frame_cap, seL4_CPtr vspace, seL4_Word vaddr, seL4_CapRights_t rights,
                     seL4_ARM_VMAttributes attr, frame_ref_t frame_ref);
