...
PACKED struct frame {
    ...
    /* Unused bits */
    char unused : 2;
    /* vaddr to link back to page table on pageout, word aligned so don't compress */
    uintptr_t vaddr: 64;
    pt_meta_t *pt;
};
...
/*
* Remap an existing frame reference to the non-software page table and re-set reference bit.
*/
